<template>
    <app-timeline>
        ...
        <app-timeline-item variant="success">
            ...
            <b-button v-b-toggle.report-list v-ripple.400="'rgba(113, 102, 240, 0.15)'" size="sm"
        ...
        <app-timeline-item variant="danger">
            ...
            <p>Develop an online store of electronic devices for the provided layout, as well as develop a mobile
                version of it.
                The must be compatible with any CMS.</p>
            <div class="d-flex flex-sm-row flex-column justify-content-between align-items-start">
                <!-- 1st Col -->
        ...
        <app-timeline-item variant="info">
            ...
            <p>Our main goal is to design a new mobile application for our client. The customer wants a clean &amp; flat
                design.
            </p>
            <div>
