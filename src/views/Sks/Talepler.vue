    ...
    <div class="container">
        ...
        <b-table striped hover responsive :per-page="perPage" :current-page="currentPage" :items="events"
            ...
            <template #cell(actions)="data">
                <b-button @click="goToEventPage(data.item.link)" size="sm"
                    :variant="data.item.isEdited ? 'success' : 'primary'">
                    {{ data.item.isEdited ? "Düzenlen Talep" : "Talebe Git" }}
                </b-button>
            </template>
        </b-table>
...
export default {
    data() {
        return {
            ...
            sortDesc: false,
            filter: null,
            filterOn: ["title", "location", "community"],
            fields: [
            ...
            events: [
                { id: 1, title: "Etkinlik 1", date: "2025-01-12", location: "Konferans Salonu", community: "Yazılım Topluluğu", isEdited: false, link: "a40d630b0" },
                { id: 2, title: "Etkinlik 2", date: "2025-01-15", location: "Toplantı Odası", community: "Elektrik Topluluğu", isEdited: true, link: "af7cfb95f" },
                { id: 3, title: "Etkinlik 3", date: "2025-01-20", location: "Açık Alan", community: "Mühendislik Topluluğu", isEdited: false, link: "b29d6746c" },
            ],
        };
    },
    mounted() {
